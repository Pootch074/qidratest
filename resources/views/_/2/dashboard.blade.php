    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <div class="bg-white shadow-md rounded-lg p-4">
            ...
            <div class="flex justify-between items-center mt-2">
                ...
                <img src="{{ asset('assets/icons/icon-dashboard-aggregate.png') }}" alt="Total Assessment" class="h-10 w-10">
            </div>
        </div>
        <div class="bg-white shadow-md rounded-lg p-4">
                ...
                <div class="flex flex-col md:flex-row justify-between items-center mb-4">
                    <div class="relative w-full md:w-1/2">
                        <span class="absolute inset-y-0 left-0 flex items-center pl-3">
                            <img src="{{ asset('assets/icons/icon-search.png') }}" alt="Search" class="h-5 w-5">
                        </span>
                    ...
                    <div class="flex items-center space-x-2 mt-2 md:mt-0">
                        <img src="{{ asset('assets/icons/icon-filter.png') }}" alt="Filter" class="h-5 w-5">
