...
@section('content')
    <div class="w-full p-4 bg-gray-200" x-data="queueApp()">
        ...
        <div class="p-4 sm:ml-64">
            <div class="bg-white rounded-lg p-4 overflow-x-auto shadow-lg">
                ...
                <div class="flex items-center gap-4 mb-6">
                    <input type="text" x-model="clientName" placeholder="Enter Client Name"
                    ...
                    <button :disabled="clientName.trim() === ''" @click="showSections = true"
                        ...
                        @foreach ($sections as $section)
                            @if ($authUser->user_type == 3 || $authUser->section_id == $section->id)
                                <form id="form-{{ $section->id }}" action="{{ route('pacd.generate', $section->id) }}"
                                    ...
                                    <button type="button" @click="showModal = true; selectedSection = {{ $section->id }}"
                ...
                <div x-show="showModal"
                    ...
                    <div class="bg-white rounded-lg shadow-lg w-80 p-6">
                        ...
                        <div class="flex flex-wrap justify-center gap-3">
                            {{-- Regular --}}
                            <button type="button" @click="generateQueue(selectedSection, 'regular').then(() => reset())"
                                class="text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-1 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 shadow-lg shadow-blue-500/50 dark:shadow-lg dark:shadow-blue-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">
                                Regular
                            </button>

                            {{-- Priority only for section_id == 15 --}}
                            <button type="button" @click="generateQueue(selectedSection, 'priority').then(() => reset())"
                        ...
                        iframe.onload = () => {
                            ...
                            printWindow.onafterprint = () => {
                                try {
                                    ...
                                    if (root && root.__x && root.__x.$data && typeof root.__x.$data.reset ===
                                        'function') {
                                        root.__x.$data.reset();
                                    }
                                } catch (e) {
