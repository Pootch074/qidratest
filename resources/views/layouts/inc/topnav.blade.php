...
<header class="bg-white text-[#202224] py-4 px-10 flex justify-between items-center">
    ...
    <div class="text-[18px]">
        ...
        @if(auth()->user()->user_type == 1)<a href="{{ route('period-management') }}" class="text-white text-xs rounded-full border-[#a5a8ae] bg-[#7d818a] px-3 py-1 ml-2 align-middle font-light text-[14px]">@if(isset($currentPeriod->id) && $currentPeriod->id > 0) Change Period @else Select Period @endif</a>@endif
