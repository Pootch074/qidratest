        ...
        <ul class="space-y-2 font-medium">
            <li>
               ...
               {{ request()->routeIs('pacd') ? 'bg-[#F03D46]' : 'hover:bg-[#5057c9]' }}">
                    <img src="{{ Vite::asset('resources/images/icons/scan.png') }}" alt="Users"
                        class="shrink-0 w-7 h-7 transition duration-75 group-hover:opacity-80">
                    <span class="ms-3">Generate Ticket</span>
                </a>
            </li>
            ...
            <li>
               ...
               {{ request()->routeIs('pacd.pending.table') ? 'bg-[#F03D46]' : 'hover:bg-[#5057c9]' }}">
                    <img src="{{ Vite::asset('resources/images/icons/pause-circle.png') }}" alt="Users"
                        class="shrink-0 w-7 h-7 transition duration-75 group-hover:opacity-80">
            ...
            <li>
               ...
               {{ request()->routeIs('pacd.transactions.table') ? 'bg-[#F03D46]' : 'hover:bg-[#5057c9]' }}">
                    <img src="{{ Vite::asset('resources/images/icons/community.png') }}" alt="Users"
                        class="shrink-0 w-7 h-7 transition duration-75 group-hover:opacity-80">
            ...
            <li>
                <a href="{{ route('pacd.clients.table') }}"
                    class="flex items-center p-2 text-white rounded-lg group
               {{ request()->routeIs('pacd.clients.table') ? 'bg-[#F03D46]' : 'hover:bg-[#5057c9]' }}">
                    <img src="{{ Vite::asset('resources/images/icons/scan.png') }}" alt="Users"
                        class="shrink-0 w-7 h-7 transition duration-75 group-hover:opacity-80">
                    <span class="ms-3">Client Logs</span>
                </a>
            </li>
