...
<li class="mx-1 my-2">
    <a href="{{ route('profile') }}" class="flex items-center p-3 rounded-lg text-white hover:bg-[#DB0C16] {{ Request::is('profile') ? 'bg-[#DB0C16]' : '' }}">
...
<li class="mx-1 my-2">
    <a href="{{ route('deadlines') }}" class="flex items-center p-3 rounded-lg text-white hover:bg-[#DB0C16] {{ Request::is('deadlines') ? 'bg-gray-300' : '' }}">
