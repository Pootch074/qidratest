    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <div class="bg-white shadow-md rounded-2xl px-4 py-10">
            ...
            <div class="flex justify-between items-center mt-2">
                ...
                <div class="p-2 rounded-[15px] bg-[#DB0C16]"><img src="{{ Vite::asset('assets/icons/icon-assessment.svg') }}" alt="Search" class="h-7 w-7"></div>
            </div>
        </div>
        <div class="bg-white shadow-md rounded-2xl px-4 py-10">
            ...
            <div class="bg-white shadow-md rounded-lg p-4 mt-4">
                <div class="flex flex-col md:flex-row justify-between items-center mb-4">
                    ...
                    <div class="flex items-center space-x-2 mt-2 md:mt-0">
                        <img src="{{ Vite::asset('assets/icons/icon-filter.svg') }}" alt="Filter" class="h-5 w-5">
