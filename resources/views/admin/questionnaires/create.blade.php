<div x-data="{ open: false }">
    ...
    <a href="#" @click.prevent="openModal(false)"
        ...
        <img src="{{ Vite::asset('resources/assets/icons/icon-plus.svg') }}" class="h-5 w-5" alt="New Questionnaire">
                ...
                <div x-show="showModal" x-transition:enter="ease-out duration-300"
                    ...
                    <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        <h3 class="text-2xl font-semibold text-gray-900 mb-4" id="modal-title"
                            x-text="editMode ? 'Edit Questionnaire' : 'Add New Questionnaire'"></h3>

                        <!-- Form -->
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <!-- Questionnaire Name -->
                            <div>
                                <label class="block text-sm text-[#75777C]">Questionnaire Name</label>
                                <input type="text" x-model="newQ.questionnaire_name" name="questionnaire_name" required
                            ...
                            <!-- Last Name -->
                            <div>
                                <label class="block text-sm text-[#75777C]">Effectivity Date</label>
                                <input type="date" x-model="newQ.effectivity_date" name="effectivity_date"
                                    class="mt-1 block w-full px-3 py-2 border border-[#CDCFD2] text-[#101828] rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                            </div>
                        </div>
                        ...
                        <div class="py-3 sm:flex sm:flex-row-reverse mt-4">
                            <button @click="editMode ? updateQ() : addQ()" type="submit"
