        ...
        <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            ...
            <form class="space-y-6" action="{{ route('authenticate') }}" method="POST">
                ...
                <div class="relative mt-2">
                    <img src="{{ asset('build/assets/icons/icon-email.png') }}" alt="Email"
                ...
                <div class="relative mt-2">
                    <img src="{{ asset('build/assets/icons/icon-password.png') }}" alt="Password"
                        class="absolute left-4 top-1/2 transform -translate-y-1/2 w-9 h-9">
                ...
                <div class="relative mt-2 flex items-center space-x-2">
                    ...
                    <label for="terms" class="text-sm">You accept <a href="#" class="text-[#FFCC00]">terms and conditions</a> chuchu</label>
                </div>
