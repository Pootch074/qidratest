...
@section('content')
    <div id="auth-login" class="mt-2 flex min-h-full flex-col justify-center px-2 py-2 lg:px-8 w-1/3 mx-auto bg-[#2E3192]/5 backdrop-blur-md rounded-[25px] text-white shadow-lg border border-white/20">

        <div class="sm:mx-auto sm:w-full sm:max-w-sm">
            <img src="{{ asset('assets/images/dswd-color.png') }}" alt="DSWD - SDCA">
        </div>
            ...
            <form class="space-y-6" action="{{ route('authenticate') }}" method="POST">
                ...
                <div class="relative mt-2">
                    ...
                    <input type="text" name="employee_id" id="employee_id" autocomplete="off" required
                        placeholder="11-1234" aria-placeholder="11-1234"
                        maxlength="7"
